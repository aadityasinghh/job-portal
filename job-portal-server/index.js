...
// mongodb+srv://adityasrinet2912:<password>@job-portal.bkqwabi.mongodb.net/?retryWrites=true&w=majority
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@job-portal.bkqwabi.mongodb.net/?retryWrites=true&w=majority`;
